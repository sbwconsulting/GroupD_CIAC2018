...
import excel using "$work/CIAC 2018 Savings completes v unresponsives.xlsx", firstrow sheet("Sampled Complete NEW") clear
...
import excel using "$work/CIAC 2018 Savings completes v unresponsives.xlsx", firstrow sheet("Sampled Unresponsive NEW") clear
...
import excel using "$work/CIAC 2018 Savings completes v unresponsives.xlsx", firstrow sheet("All Sampled NEW") clear
duplicates tag SBW_ProjID, generate(claim_flag)
order claim_flag
sort claim_flag
replace claim_flag=claim_flag+1
